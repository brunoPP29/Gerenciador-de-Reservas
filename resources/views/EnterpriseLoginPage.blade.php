...
<body class="bg-gray-900 text-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8 space-y-6 border border-gray-700">
        ...
        <form method="post" class="space-y-4">
            ...
            {{-- Password Input (Note: Corrected typo from 'passowrd' to 'password' in type and placeholder for better UX, but kept 'passoword' in name to match original if it was intentional) --}}
            <div>
